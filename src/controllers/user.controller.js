...
const refreshAccessToken = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if (!user) throw new ApiError(401, "Invalid refreshh token");
        if (incomingRefreshToken !== user?.refreshToken)
            throw new ApiError(401, "Refresh tokin is expired or used");
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, user, "Cover Image updated successfullu]y"));
});
...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, user, "Avatar updated successfullu]y"));
});
